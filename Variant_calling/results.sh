...
#extract variants from pilot.vcf that have HM3 membership flag and extract such variants from gt.vcf
...
#36 individuals have missing genotype more than 10%
...
# making a vcf file of the filtered individuals
...
# 88 variants are common in AN of both vcf files
